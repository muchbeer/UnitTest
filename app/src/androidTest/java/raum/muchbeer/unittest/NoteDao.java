...
public class NoteDao extends NoteDatabaseTest {
...
public void insertReadDelete() throws Exception {
    ...
    // insert
    getNoteDao().insertNote(note).blockingGet(); // wait until inserted because it is RxJava
...
//With this sqliteconstraintException am telling room am excepting exception
